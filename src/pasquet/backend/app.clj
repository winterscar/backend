(ns pasquet.backend.app
  (:require [com.biffweb :as biff :refer [q]]
            [pasquet.backend.middleware :as mid]
            [pasquet.backend.ui :as ui]
            [pasquet.backend.settings :as settings]
            [rum.core :as rum]
            [xtdb.api :as xt]
...
(defn notify-clients [{:keys [pasquet.backend/chat-clients]} tx]
...
(defn ws-handler [{:keys [pasquet.backend/chat-clients] :as ctx}]
  {:status 101
