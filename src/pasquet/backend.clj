(ns pasquet.backend
  (:require [com.biffweb :as biff]
            [pasquet.backend.email :as email]
            [pasquet.backend.app :as app]
            [pasquet.backend.home :as home]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"pasquet.backend.*-test"))
...
(def initial-system
  {:biff/modules #'modules
   ...
   :pasquet.backend/chat-clients (atom #{})})
